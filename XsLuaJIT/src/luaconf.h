...
#define LUA_PATH_DEFAULT   "?.script;lib\\?.lua"

#define LUA_CPATH_DEFAULT  LUA_CDIR"?.dll"
...
# define luai_apicheck(L,assertion) lxs_assert(L, assertion)
#else
...
#define lua_number2int(i,d) __asm fld d __asm fisttp i /* SSE3I: fisttp; x87: fistp */
